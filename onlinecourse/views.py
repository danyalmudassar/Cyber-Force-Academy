...
from .models import Course, Enrollment, Question, Choice, Submission, ExamSession
...
def submit(request, course_id):
    ...
    submission = Submission.objects.create(enrollment=enrollment, timestamp=now())
...
def show_exam_result(request, course_id, submission_id):
    ...
    for question in questions:
        max_score += question.grade  # Add up maximum possible points
